...
wget -q -O /etc/slowdns/server.key "https://raw.githubusercontent.com/KhaiVpn767/SlowDns/main/slowdns/server.key"
wget -q -O /etc/slowdns/server.pub "https://raw.githubusercontent.com/KhaiVpn767/SlowDns/main/slowdns/server.pub"
wget -q -O /etc/slowdns/sldns-server "https://raw.githubusercontent.com/KhaiVpn767/SlowDns/main/slowdns/sldns-server"
wget -q -O /etc/slowdns/sldns-client "https://raw.githubusercontent.com/KhaiVpn767/SlowDns/main/slowdns/sldns-client"
cd
...
[Unit]
Description=Client SlowDNS By khaiVPN
Documentation=https://khaiVPN.com
...
[Unit]
Description=Server SlowDNS By khaiVPN
Documentation=https://khaiVPN.com
After=network.target nss-lookup.target
